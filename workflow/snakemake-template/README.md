...
- [Snakemake workflow:](#snakemake-workflow-name) [`<name>`](#snakemake-workflow-name)
...
The [profiles](profiles/README.md) [`README.md`](profiles/README.md) provides more details.
